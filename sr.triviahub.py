...
@client.command(pass_context=True)
async def ha(ctx):
    embed = discord.Embed(title="**MAKE IN INDIA**", description="Fetching Answer For HQ", color=0x00ff00)
    embed.set_footer(text="©MAKE IN INDIA Made with 💓 by *╔═══❖•ೋ°☆《●RiTEsH ●》☆°ೋ•❖═══╗*#2150 .")
...
@client.command(pass_context=True)
async def ta(ctx):
    embed = discord.Embed(title="**MAKE IN INDIA**", description="Fetching Answer For THE Q", color=0x00ff00)
    embed.set_footer(text="©MAKE IN INDIA Made with 💓 by *╔═══❖•ೋ°☆《●RiTEsH ●》☆°ೋ•❖═══╗*#2150 .")
...
@client.command(pass_context=True)
async def qla(ctx):
    embed = discord.Embed(title="**MAKE IN INDIA**", description="Fetching Answer For Q LIVE", color=0x00ff00)
    embed.set_footer(text="©MAKE IN INDIA Made with 💓 by *╔═══❖•ೋ°☆《●RiTEsH ●》☆°ೋ•❖═══╗*#2150 .")
